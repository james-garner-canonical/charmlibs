...
"""Example requirer charm requesting an application-scoped certificate."""
...
REQUESTS = [tls_certificates.CertificateRequestAttributes(common_name="app.example.com")]


class AppRequirerCharm(ops.CharmBase):
    """A requirer charm whose certificate belongs to the application, not the unit."""
