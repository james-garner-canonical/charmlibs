...
This library provides the provider and requirer sides of the ``gateway_metadata``
...
The ``gateway_metadata`` interface provides an umbrella relation containing gateway
