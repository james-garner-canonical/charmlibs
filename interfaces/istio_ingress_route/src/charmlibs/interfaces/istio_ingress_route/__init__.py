...
This library provides the provider and requirer sides of the ``istio_ingress_route``
...
The ``istio_ingress_route`` interface fills this gap. It allows requiring charms to
