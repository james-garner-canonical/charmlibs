...
The `istio_ingress_route` interface library.

To install, add `charmlibs-interfaces-istio-ingress-route` to your Python dependencies. Then in your Python code, import as:
