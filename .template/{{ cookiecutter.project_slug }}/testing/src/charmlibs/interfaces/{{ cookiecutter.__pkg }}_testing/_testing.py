...
class _Remote:
    ...
    ``get_relation`` are generic, and every {{ cookiecutter.__ns }} testing package
...
class RemoteProvider(_Remote):
    """A simulated {{ cookiecutter.project_slug }} provider, for testing a **requirer** charm.
...
class RemoteRequirer(_Remote):
    """A simulated {{ cookiecutter.project_slug }} requirer, for testing a **provider** charm.
