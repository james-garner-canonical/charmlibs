...
See the [reference documentation](https://canonical.com/juju/docs/charmlibs/reference/charmlibs/{{ cookiecutter.__path_prefix }}{{cookiecutter.__canonical_name}}) for more.
