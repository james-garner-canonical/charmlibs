...
class TestEnsure:
    ...
    def test_not_installed_revision(self, mock_snapd):
        mock_snapd.info.return_value = None
    ...
    def test_not_installed_classic(self, mock_snapd):
        mock_snapd.info.return_value = None
    ...
    def test_installed_same_channel(self, mock_snapd):
    ...
    def test_installed_normalized_channel(self, mock_snapd):
        mock_snapd.info.return_value = make_info(channel='latest/stable')
...
def test_normalize_channel(channel, expected):
